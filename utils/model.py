...
def train_model(features, labels, args):
    ...
    :param args: Run GridSearchCV or not
    :return:
    """
    ...
    if args.gs:
        ...
        dec_trees = RandomForestClassifier(max_features='sqrt',
                                           ...
                                           max_depth=gs.best_params_[
                                               'max_depth'] if 'max_depth' in param_grid else None,
        ...
        plot_graph(model.estimators_[0], features, labels, 'RandomForest-graph-gs')
